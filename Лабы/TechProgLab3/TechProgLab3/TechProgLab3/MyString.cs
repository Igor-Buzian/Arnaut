...
namespace TechProgLab3
{
    internal class MyString
    {
        ...
        //Left
        public char[] Left(int totalWidth)
        {
        ...
        public char[] Left(int totalWidth, char paddingChar)
        {
            List<char> spaces = new List<char>();
        ...
        //Right
        public char[] Right(int totalWidth)
        {
            List<char> spaces = new List<char>();
        ...
        public char[] Right(int totalWidth, char paddingChar)
        {
            List<char> spaces = new List<char>();
