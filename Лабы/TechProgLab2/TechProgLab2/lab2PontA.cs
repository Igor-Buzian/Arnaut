...
using TP_Lab2;
/*Разработать приложение, позволяющее точно решить систему из N линейных уравнений с N неизвестными (например, можно использовать метод Краммера). 
Коэффициенты системы будут рациональными числами. Для возможности оперировать коэффициентами системы создается класс NumRational, перегружая его операторами +, -, *, /. 
Использовать разные способы инициализации коэффициентов системы: инициализация с клавиатуры, случайная инициализация. 
При чтении коэффициентов с клавиатуры следует учитывать, что рациональные числа могут иметь 2 представления (например, 1,23 или 128/100).*/
namespace TP_Lab2
{
    internal class lab2PontA
    {
            ...
            Console.Write("\n1.Random linear equations.\b 2.Your linear equations\nYour Choose: ");
